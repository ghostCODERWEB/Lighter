...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'zklighter/ (api/6.1.3)');
    }
    /**
     ...
     */
    SDK.prototype.account = function (metadata) {
     ...
     */
    SDK.prototype.accountActiveOrders = function (metadata) {
     ...
     */
    SDK.prototype.accountInactiveOrders = function (metadata) {
     ...
     */
    SDK.prototype.accountLimits = function (metadata) {
     ...
     */
    SDK.prototype.accountMetadata = function (metadata) {
     ...
     */
    SDK.prototype.accountTxs = function (metadata) {
     ...
     */
    SDK.prototype.accountsByL1Address = function (metadata) {
     ...
     */
    SDK.prototype.announcement = function () {
     ...
     */
    SDK.prototype.apikeys = function (metadata) {
     ...
     */
    SDK.prototype.block = function (metadata) {
     ...
     */
    SDK.prototype.blockTxs = function (metadata) {
     ...
     */
    SDK.prototype.blocks = function (metadata) {
     ...
     */
    SDK.prototype.candlesticks = function (metadata) {
     ...
     */
    SDK.prototype.changeAccountTier = function (body, metadata) {
     ...
     */
    SDK.prototype.currentHeight = function () {
     ...
     */
    SDK.prototype.deposit_history = function (metadata) {
     ...
     */
    SDK.prototype.exchangeStats = function () {
     ...
     */
    SDK.prototype.export = function (metadata) {
     ...
     */
    SDK.prototype.fastbridge_info = function () {
     ...
     */
    SDK.prototype.fundingRates = function () {
     ...
     */
    SDK.prototype.fundings = function (metadata) {
     ...
     */
    SDK.prototype.l1Metadata = function (metadata) {
     ...
     */
    SDK.prototype.liquidations = function (metadata) {
     ...
     */
    SDK.prototype.nextNonce = function (metadata) {
     ...
     */
    SDK.prototype.notification_ack = function (body, metadata) {
     ...
     */
    SDK.prototype.orderBookDetails = function (metadata) {
     ...
     */
    SDK.prototype.orderBookOrders = function (metadata) {
     ...
     */
    SDK.prototype.orderBooks = function (metadata) {
     ...
     */
    SDK.prototype.pnl = function (metadata) {
     ...
     */
    SDK.prototype.positionFunding = function (metadata) {
     ...
     */
    SDK.prototype.publicPoolsMetadata = function (metadata) {
     ...
     */
    SDK.prototype.recentTrades = function (metadata) {
     ...
     */
    SDK.prototype.referral_points = function (metadata) {
     ...
     */
    SDK.prototype.sendTx = function (body) {
     ...
     */
    SDK.prototype.sendTxBatch = function (body) {
     ...
     */
    SDK.prototype.trades = function (metadata) {
     ...
     */
    SDK.prototype.transfer_history = function (metadata) {
     ...
     */
    SDK.prototype.transferFeeInfo = function (metadata) {
     ...
     */
    SDK.prototype.tx = function (metadata) {
     ...
     */
    SDK.prototype.txFromL1TxHash = function (metadata) {
     ...
     */
    SDK.prototype.txs = function (metadata) {
     ...
     */
    SDK.prototype.withdraw_history = function (metadata) {
     ...
     */
    SDK.prototype.withdrawalDelay = function () {
